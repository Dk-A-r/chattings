...
Приложение понимает запросы на английском языке и возвращает ответы на нем же. Для начала работы с приложением необходимо ввести token с HuggingfaceHub (с правом write). Для прекращения диалога можно ввести команду "quit".
